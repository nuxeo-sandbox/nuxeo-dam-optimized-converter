 ...
 *     Michael Vachette
 */
package org.nuxeo.labs.dam.converters.video;
...
@Deploy({
        "nuxeo-dam-optimized-video-converter",
        "org.nuxeo.ecm.platform.tag",
        "org.nuxeo.ecm.platform.video",
        "nuxeo-dam-optimized-video-converter:mock-blobprovider-conrib.xml"
})
public class TestStreamVideoConverter {

    static final String MOCK_PROVIDER_NAME = "mockprovider";
    ...
    public void isLoaded() {
        assertNotNull(blobManager.getBlobProvider(MOCK_PROVIDER_NAME));
    ...
    protected Blob getRemoteBlob() throws IOException {
        BlobProvider myProvider = blobManager.getBlobProvider(MOCK_PROVIDER_NAME);
        BlobInfo blobInfo = new BlobInfo();
        blobInfo.key = MOCK_PROVIDER_NAME+":https://github.com/nuxeo-sandbox/nuxeo-dam-optimized-converter/raw/master/nuxeo-dam-optimized-converter-core/src/test/resources/files/nuxeo.3gp";
